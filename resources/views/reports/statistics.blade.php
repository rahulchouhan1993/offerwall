               ...
               <label class="min-w-[160px] w-[10%] text-[14px] font-[500] text-[#898989] ">Active filters:</label>
                  <div class="w-[90%] flex flex-wrap items-center gap-[10px] allFilterInCommon">
                     @if(!empty($filterByValue))
                        ...
                        <div class="flex items-center gap-[20px] bg-[#F6F6F6] pl-[15px] text-[14px] font-[600] text-[#4D4D4D] border-[1px] border-[#E6E6E6] rounded-[4px] hover:outline-none focus:outline-none"> <input type="hidden" name="filterIn[{{ $k }}][]" value="{{ $inValue[0] }}"><input type="hidden" name="filterInValue[{{$k }}][]" value="{{ $filterByText[$k][0] }}"> {{ $filterByText[$k][0] }} 
                        <button class="removeActiveOne w-[40px] h-[40px] flex items-center justify-center gap-[5px] bg-[#D272D2] text-[#fff] border-l-[1px] border-l-[#E6E6E6]"> <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M10.4033 1.29822L0.999773 10.7018" stroke="#A1A1A1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /> <path d="M10.4033 10.7018L0.999772 1.29822" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /> </svg> </button> </div>
                        @endforeach
                     @endif
                  </div>
             </div>
