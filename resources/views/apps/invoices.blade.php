                ...
                <form>
                    <div class="flex flex-wrap md-flex-nowrap items-start gap-[7px] md:gap-[15px] justify-end mb-[15px]">
                        ...
                        <div class="relative w-full md:w-auto">
                            <button type="submit"
                                class="w-full md:w-[110px] lg:w-[140px] bg-[#D272D2] px-[20px] py-[10px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center">+
                                Add</button>
                        </div>
                    </div>
                </form>
            ...
            <div class="flex w-full flex-col-reverse flex-wrap justify-between gap-[20px] sm:flex-row md:items-center">
                <div class="">
                    <div class="max-w-[180px]">
                        <select name="" id=""
                            class="w-full appearance-none bg-[#d272d2] px-[5px] text-sm text-white outline-none focus:outline-none">
