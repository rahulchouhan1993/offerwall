            ...
            <div class="w-full bg-white p-[15px] md:p-[20px] rounded-[10px] custom_filter">
                <form >
                    <div  class="flex flex-wrap md-flex-nowrap items-start gap-[15px] justify-end mb-[15px]" >
                        ...
                        <div class="relative">
                            <button type="submit" class="w-[100px] md:w-[110px] lg:w-[140px] bg-[#D272D2] px-[20px] py-[10px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center">+ Add</button>
                        </div>
                    </div>
                </form>
