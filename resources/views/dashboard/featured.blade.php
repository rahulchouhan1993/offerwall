        ...
        <div class="bg-[#fff] p-[15px] md:p-[20px] rounded-[8px] md:rounded-[10px]">
            ...
            <div class="repeater">
                ...
                <div class="flex gap-[10px] md:gap-[20px] mt-[15px]">
                    <a href="javascript:void(0);" data-repeater-create class="w-[120px] bg-[#D272D2] px-[10px] py-[11px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center" > Add </a>
