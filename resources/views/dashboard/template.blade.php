    ...
    <div class='w-[100%] lg:w-[70%] bg-[#fff] p-[20px] rounded-[10px]'>
        <div class='flex flex-col gap-[15px] mb-[25px]'>
            ...
            <div class='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4'>
                <div class="relative flex flex-col gap-[5px]">
                    <label class='text-[14] text-[#898989] mb-[2px]'>Header BG</label>
                    <div class='flex gap-[10px] bg-[#fff] p-[6px] rounded-[8px] border-[1px] border-[#e5e7eb] rounded-[4px]'>
                        <input class='min-w-[30px] h-[30px] commonColourPicker' type="color" name="color" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="#bada55" /> 
        ...
        <div class='flex flex-col gap-[15px] mb-[25px]'>
            ...
            <div class='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4'>
                ...
                <div class="relative flex flex-col gap-[5px]">
                    <label class='text-[14] text-[#898989] mb-[2px]'>Offer Title Color</label>
                    <div class='flex gap-[10px] bg-[#fff] p-[6px] rounded-[8px] border-[1px] border-[#e5e7eb] rounded-[4px]'>
                        <input class='min-w-[30px] h-[30px] commonColourPicker' type="color" name="color" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="#bada55" /> 
                        <input class='w-[100%] commonColourNumber' type="text" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="#bada55"  />
                    </div>
                ...
                <div class="relative flex flex-col gap-[5px]">
                    <label class='text-[14] text-[#898989] mb-[2px]'>Offer Description Color</label>
                    <div class='flex gap-[10px] bg-[#fff] p-[6px] rounded-[8px] border-[1px] border-[#e5e7eb] rounded-[4px]'>
                        <input class='min-w-[30px] h-[30px] commonColourPicker' type="color" name="color" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="#bada55" /> 
                        <input class='w-[100%] commonColourNumber' type="text" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="#bada55"  />
                    </div>
    ...
    <div style=" display:flex;   flex-direction: column; align-items: start; width: 100%;">
        <div style="display: flex ;   align-items: center; justify-content: space-between; width: 100%;">
            <ul style="display: flex; align-items: center; justify-content: start; gap: 15px; padding: 0; margin: 0; list-style: none;">
                <li><a href="#" style="display: block; padding: 4px 5px;  color: #000; border-bottom: 1px solid transparent;text-decoration: none; font-size:11px;">Offers</a></li>
            </ul>
        ...
        <div style="display: flex ; align-items: center; justify-content: space-between; background: #48B5AD; padding: 5px 10px; width: 100%;">
           <p class="cntbx" style="margin: 0; font-size: 11px; color: #fff;">Register and complete your survey profile to access all our surveys.</p>
