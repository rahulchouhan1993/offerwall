        ...
        <div class="w-full bg-white p-[15px] md:p-[20px] rounded-[10px]">
            <div class="overflow-x-scroll tableScroll">
                <table class="w-full border-collapse border-spacing-0 rounded-[10px] border-separate border border-[#E6E6E6]">
                    <thead>
                        <tr>
                            <th class="bg-[#F6F6F6] rounded-tl-[10px] text-[12px] font-medium text-[#1A1A1A] px-[10px] py-[13px] text-left whitespace-nowrap">Name</th>
                            <th class="bg-[#F6F6F6] text-[12px] font-medium text-[#1A1A1A] px-[10px] py-[13px] text-left whitespace-nowrap">Email</th>
                            <th class="max-w-[250px] bg-[#F6F6F6] text-[12px] font-medium text-[#1A1A1A] px-[10px] py-[13px] text-left whitespace-nowrap">Message</th>
                            <th class="bg-[#F6F6F6] text-[12px] font-medium text-[#1A1A1A] px-[10px] py-[13px] text-left whitespace-nowrap">Status</th>
                            <th class="bg-[#F6F6F6] text-[12px] font-medium text-[#1A1A1A] px-[10px] py-[13px] text-left whitespace-nowrap">Created</th>
                            <th class="bg-[#F6F6F6] rounded-tr-[10px] text-[12px] font-medium text-[#1A1A1A] px-[10px] py-[13px] text-left whitespace-nowrap">Action</th>
                        </tr>
                    </thead>
                    <tbody>
