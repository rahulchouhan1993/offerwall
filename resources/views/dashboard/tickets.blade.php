    ...
    <main id="chatwindowMain" style="display: none;" class="chatwindowMain w-full md:w-2/3 lg:w-3/4 bg-gray-50 flex flex-col relative rounded-[10px] shadow-md">
        ...
        <div id="chatInputBar"
            ...
            <div class="relative flex items-center">
                <label for="fileInput" class="cursor-pointer flex items-center justify-center w-[35px] bg-[#d272d2] py-[10px] w-[100px] border border-[#33c33b] rounded-[4px] text-[14px] font-[500] text-white text-center mb-[0]">
        ...
        fetch(`/ticketMessages/${ticketId}`)
            ...
            .then(data => {
                ...
                data.messages.forEach(msg => {
                    ...
                    timestamp.className = msg.from == "admin"
                        ? 'chatWindowDate w-full text-end text-white flex justify-end gap-[5px] items-center text-[12px] text-[#000]' : 'chatWindowDate w-full text-end text-black flex justify-end gap-[5px] items-center text-[12px] text-[#000]';
                    ...
                    timestamp.innerHTML = msg.from == "admin"
                        ? `${formattedDate} <div class="text-[12px] text-white font-[600]">${formattedTime}</div>` : `${formattedDate} <div class="text-[12px] text-black font-[600]">${formattedTime}</div>`;
