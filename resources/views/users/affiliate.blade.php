    ...
    <div class="flex flex-col lg:flex-row justify-between items-start gap-[15px] w-[100%] ">
        <div class="w-[100%] lg:w-[100%] bg-[#fff] p-[15px] md:p-[20px] rounded-[10px]">
            <div class="flex flex-wrap md:flex-nowrap items-center justify-between gap-[10px] mb-[20px]">
                ...
                <a href="{{ route('resync') }}" class="w-[100px] bg-[#D272D2] px-[20px] py-[10px] w-[100px] rounded-[4px] text-[14px] font-[500] text-[#fff] text-center ml-[auto]" >Resync</a>
            ...
            <div class=" overflow-x-scroll tableScroll">
                <table class="w-[100%] border-collapse border-spacing-0 rounded-[10px] border-separate border border-[#E6E6E6]">
                    <tr>
                        ...
                        <th class=" bg-[#F6F6F6] rounded-tl-[10px] text-[12px] font-[500] text-[#1A1A1A] px-[10px] py-[13px] text-left whitespace-nowrap ">Payment Methods</th>
                    ...
                    <tr>
                        ...
                        <div class="flex items-center justify-end gap-[10px]">
                            @if(!$validateUserCreation && $affiliate['status']=='active')
                                <a href="javascript:void(0);" onclick="addAffiliateUser(this,{{ $affiliate['id'] }},'{{ $affiliate['email'] }}','{{ $affiliate['login'] }}','{{ $affiliate['api_key'] }}','{{ $affiliate['address_1'] }}','{{ $affiliate['address_2'] }}','{{ $affiliate['city'] }}','{{ $affiliate['country'] }}','{{ $affiliate['zip_code'] }}')" class="w-[30px] h-[30px] bg-[#30c2ee] rounded-[5px] flex items-center justify-center text-[17px] text-[#fff]">
                                    <!-- Add User -->
