            ...
            <div class=" overflow-x-scroll tableScroll">
                ...
                @if(!empty($allAffiliates['partners']))
                    ...
                    <tr>
                        ...
                        <td title="cebad6fc330de7124462cb182e9c2cd17991cbf2" class="text-center text-[12px] font-[500] text-[#808080] px-[10px] py-[10px] whitespace-nowrap  border-b-[1px] border-b-[#E6E6E6]"><a href="{{ route('payment.details') }}" class="inline-block">
